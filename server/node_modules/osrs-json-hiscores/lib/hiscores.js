...
function getRSNFormat(rsn, config, mode) {
    ...
    if (mode === void 0) { mode = 'main'; }
    return __awaiter(this, void 0, void 0, function () {
        var url, response, dom, row, innerHTML, _c;
            ...
            switch (_d.label) {
                ...
                case 2:
                    ...
                    if (row) {
                        ...
                        return [2 /*return*/, ((_b = (_a = innerHTML === null || innerHTML === void 0 ? void 0 : innerHTML.match(new RegExp(rsn.replace(utils_1.WHITESPACE_REGEX, utils_1.WHITESPACE_REGEX_STRING), 'gi'))) === null || _a === void 0 ? void 0 : _a[0]) !== null && _b !== void 0 ? _b : rsn)];
                    }
                    return [3 /*break*/, 4];
                case 3:
                    _c = _d.sent();
